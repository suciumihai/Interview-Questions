...
public class CandidateServiceController {
    ...
    private static Map<String, Candidate> candidateRepo = new HashMap<>(); //asta l-am folosit sa testez daor serviciul

    @Autowired
    private CandidateRepository candidateRepository;
    //asta va trebi sa il folosesc sa testez direct cu repository in db
